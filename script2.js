...
const blankImage = 'on.png'; // Replace with the path to your blank image
...
imageContainer2.style.backgroundImage = url(${textImage});

// Revert to the blank image after the subliminal duration
setTimeout(() => {
imageContainer2.style.backgroundImage = url(${blankImage});
}, subliminalDuration);
}
